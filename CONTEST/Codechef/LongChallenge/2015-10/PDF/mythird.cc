...
main (int argc, char *argv[])
{
  ...
  AnimationInterface::SetConstantPosition (csmaNodes.Get (0), 20, 20);
  ...
  AnimationInterface::SetConstantPosition (wifiApNode.Get (2), 10, 10);
  AnimationInterface::SetConstantPosition (csmaNodes.Get (0), 20, 20);
  AnimationInterface::SetConstantPosition (csmaNodes.Get (1), 30, 30);

  AnimationInterface::SetConstantPosition (wifiApNode.Get (3), 10, 10);
  AnimationInterface::SetConstantPosition (csmaNodes.Get (0), 20, 20);
  AnimationInterface::SetConstantPosition (csmaNodes.Get (1), 30, 30);
